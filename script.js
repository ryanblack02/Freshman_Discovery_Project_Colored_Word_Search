...
/* --- Word database (expanded words across categories) --- */
const words = {
  mammals: {
    kid: ["Dog","Cat","Cow","Horse","Pig","Sheep","Goat","Rabbit","Lion","Tiger",
          ...
          "Hedgehog","Bat","Raccoon","Moose","Beaver","Walrus","Cougar","Jaguar",
          "Coyote","Hyena","Mole","Chipmunk","Possum","Skunk","Reindeer","Caribou",
          "Ferret","Lynx","Marmot","Porpoise","Sealion","Pronghorn","Tapir"],
    adult: ["Aardvark","Aardwolf","Alpaca","Antelope","Bison","Capybara","Chimpanzee",
            ...
            "Wolverine","Baboon","Goral","Kinkajou","Muskox","Nilgai","Ocelot","Quokka",
            "Serval","Tamarin","Uakari","Vaquita","Wombat","Zorilla"]
  },
  birds: {
    kid: ["Chicken","Duck","Goose","Swan","Owl","Eagle","Hawk","Parrot","Penguin",
          "Flamingo","Peacock","Crow","Sparrow","Robin","Hummingbird","Toucan",
          "Woodpecker","Seagull","Pelican","Ostrich","Pigeon","Canary","Turkey",
          "Vulture","Magpie","Starling","Kingfisher","Quail"],
    adult: ["Albatross","Cassowary","Cockatoo","Condor","Crane","Falcon","Heron",
            "Hornbill","Kingfisher","Kookaburra","Macaw","Nightingale","Quail",
            "Roadrunner","Shoebill","Sunbird","Trogon","Vireo","Waxwing","Oriole",
            "Emu","Lyrebird"]
  },
  reptiles: {
    kid: ["Snake","Lizard","Turtle","Crocodile","Alligator","Chameleon","Gecko","Iguana",
          "Skink","Monitor","Garter","Anole","Komodo"],
    adult: ["Komododragon","GarterSnake","Boa","Python","Anole","Tortoise","Monitor",
            "Chameleon","Iguana","Caiman","Viper","KingCobra","Rattlesnake","GilaMonster",
            "Agama","FrilledLizard","GlassLizard","HornedLizard"]
  },
  amphibians: {
    kid: ["Frog","Toad","Salamander","Newt","TreeFrog","Bullfrog","Caecilian"],
    adult: ["Axolotl","Caecilian","TigerSalamander","Hellbender","Olm","FireSalamander",
            "MarbledSalamander"]
  },
  fish: {
    kid: ["Goldfish","Shark","Tuna","Trout","Salmon","Clownfish","Catfish","Carp","Guppy",
          "Betta","Angelfish","Pufferfish","Seahorse"],
    adult: ["Barracuda","Grouper","Swordfish","Anglerfish","Lionfish","Betta","Piranha",
            "Sturgeon","Marlin","MahiMahi","Cod","Halibut","Snapper","Catfish","Perch",
            "BlueTang","Goby","Wrasse","Blowfish"]
  },
  insects: {
    kid: ["Ant","Bee","Butterfly","Beetle","Fly","Wasp","Grasshopper","Ladybug",
          "Dragonfly","Cricket","Moth","Mosquito"],
    adult: ["Dragonfly","Cricket","Termite","Moth","Mosquito","PrayingMantis","Cicada",
            "Locust","Beetle","Firefly","StickInsect","Earwig","Sawfly","Mayfly","Silverfish"]
  },
  invertebrates: {
    kid: ["Snail","Worm","Jellyfish","Crab","Octopus","Starfish","Clam","Squid"],
    adult: ["Lobster","Scorpion","Coral","Anemone","Cuttlefish","Urchin","Shrimp",
            "Krill","Barnacle","SeaCucumber","SeaSlug","Nudibranch"]
  }
};
...
function markWordFound(word,r1,c1,r2,c2){
  ...
  foundSet.add(word);
  playDing();
  if(chosenWords.length > 0 && foundSet.size===chosenWords.length){
...
function enableInteraction(grid){
  ...
  const up = e => {
    ...
    pointerLast=cell;
    const str1=getPathWord(pointerStart[0],pointerStart[1],pointerLast[0],pointerLast[1],grid);
    const str2=getPathWord(pointerLast[0],pointerLast[1],pointerStart[0],pointerStart[1],grid);
    const foundWord = chosenWords.find(w=>w===str1||w===str2);
    if(foundWord) markWordFound(foundWord,pointerStart[0],pointerStart[1],pointerLast[0],pointerLast[1]);
    clearTemp();
  };
...
function generateWordSearch(category="mammals", difficulty="kid") {
  ...
  chosenWords = pool.sort(()=>0.5-Math.random()).slice(0,6); // select 6 random words
  chosenWordColors={};
  chosenWords.forEach((w,i)=>{
    chosenWordColors[w]={highlightClass:neonClassForIndex(i)};
  });
  foundSet.clear(); // <-- reset after chosenWords assigned
